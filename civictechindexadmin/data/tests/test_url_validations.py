...
good_github_urls = [
    ('https://www.github.com/person/repository', 'https://www.github.com/person/repository'),
    ('https://github.com/person/repository', 'https://github.com/person/repository'),
    ('http://www.github.com/person/repository', 'http://www.github.com/person/repository'),
    ('http://github.com/person/repository', 'http://github.com/person/repository'),
    ('www.github.com/person/repository', 'https://www.github.com/person/repository'),
    ('github.com/person/repository', 'https://github.com/person/repository'),
    ('github.com/per-son/repo-si.to_ry2020', 'https://github.com/per-son/repo-si.to_ry2020'),
    ('https://github.com/civictechindex', 'https://github.com/civictechindex'),
...
good_facebook_urls = [
    ('https://www.facebook.com/person', 'https://www.facebook.com/person'),
    ('https://facebook.com/person', 'https://facebook.com/person'),
    ('http://www.facebook.com/person', 'http://www.facebook.com/person'),
    ('http://facebook.com/person', 'http://facebook.com/person'),
    ('www.facebook.com/person', 'https://www.facebook.com/person'),
    ('facebook.com/person', 'https://facebook.com/person'),
    ('facebook.com/perso', 'https://facebook.com/perso'),
...
good_twitter_urls = [
    ('https://www.twitter.com/person', 'https://www.twitter.com/person'),
    ('https://twitter.com/person', 'https://twitter.com/person'),
    ('http://www.twitter.com/person', 'http://www.twitter.com/person'),
    ('http://twitter.com/person', 'http://twitter.com/person'),
    ('www.twitter.com/person', 'https://www.twitter.com/person'),
    ('twitter.com/person', 'https://twitter.com/person'),
    ('twitter.com/perso', 'https://twitter.com/perso'),
...
good_meetup_urls = [
    ('https://www.meetup.com/person', 'https://www.meetup.com/person'),
    ('https://meetup.com/person', 'https://meetup.com/person'),
    ('http://www.meetup.com/person', 'http://www.meetup.com/person'),
    ('http://meetup.com/person', 'http://meetup.com/person'),
    ('www.meetup.com/person', 'https://www.meetup.com/person'),
    ('meetup.com/person', 'https://meetup.com/person'),
